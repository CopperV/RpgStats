...
public class StatCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        var stats = RpgPlayerStatsManager.getInstance().getStats(targetPlayer.getUniqueId());
        displayStats(sender, targetPlayer.getName(), stats);
        return true;
    }

    private void displayStats(@NotNull CommandSender sender, String owner, RpgStatsHolder stats) {
